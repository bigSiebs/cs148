<?php
include "../assignment1.0/lib/constants.php";
require_once('../assignment1.0/lib/custom-functions.php');
?>
<!DOCTYPE html>
<html lang="en">
    <head>
        <title>In-class Assignment | CS 148</title>
        <meta charset="utf-8">
        <meta name="author" content="Joe Siebert">
        <meta name="description" content="Friday = fun-day.">
        ...
        require_once('../assignment1.0/lib/security.php');
